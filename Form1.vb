...
Public Class Form1
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        ...
        If InStr(TextBox1.Text, "Abdul Rehman1") And (sflag1 = 0) And tflag = 1 And mins <= 2 Then
            chkstu1.Checked = True
            sflag1 = 1
            chkstu1.Text = chkstu1.Text + " Present"
        End If

        If InStr(TextBox1.Text, "Abdul Rehman2") And (sflag2 = 0) And tflag = 1 And mins <= 2 Then
            chkstu2.Checked = True
            sflag2 = 1
            chkstu2.Text = chkstu2.Text + " Present"
        End If

        If InStr(TextBox1.Text, "Meer Hamza 1") And (sflag3 = 0) And tflag = 1 And mins <= 2 Then
            chkstu3.Checked = True
            sflag3 = 1
            chkstu3.Text = chkstu3.Text + " Present"
        End If

        If InStr(TextBox1.Text, "Meer Hmaza 2") And (sflag4 = 0) And tflag = 1 And mins <= 2 Then
        ...
        If InStr(TextBox1.Text, "Abdul Rehman1") And (sflag1 = 0) And tflag = 1 And mins > 2 And mins < 5 Then
            chkstu1.Checked = True
            sflag1 = 1
            chkstu1.Text = chkstu1.Text + " is late"
        End If

        If InStr(TextBox1.Text, "Abdul Rehman2") And (sflag2 = 0) And tflag = 1 And mins > 2 And mins < 5 Then
            chkstu2.Checked = True
            sflag2 = 1
            chkstu2.Text = chkstu2.Text + " is late"
        End If

        If InStr(TextBox1.Text, "Meer Hmaza 1") And (sflag3 = 0) And tflag = 1 And mins > 2 And mins < 5 Then
            chkstu3.Checked = True
            sflag3 = 1
            chkstu3.Text = chkstu3.Text + " is late"
        End If

        If InStr(TextBox1.Text, "Meer Hmaza 2") And (sflag4 = 0) And tflag = 1 And mins > 2 And mins < 5 Then
            chkstu4.Checked = True
            sflag4 = 1
